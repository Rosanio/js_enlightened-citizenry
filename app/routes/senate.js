...
export default Ember.Route.extend({
  model() {
    var url = 'http://congress.api.sunlightfoundation.com/committees?chamber=senate&per_page=50&apikey=817fa3b0cf4944cfb8d3729919c99c95&page=';
  ...
  actions: {
    apiCall(page) {
      var url = 'http://congress.api.sunlightfoundation.com/committees?chamber=senate&per_page=50&page='+ page + '&apikey=817fa3b0cf4944cfb8d3729919c99c95';
